...
public class SignIn extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtuserid.setFont(new java.awt.Font("Sitka Display", 1, 18)); // NOI18N
        ...
        getContentPane().add(txtuserid, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 360, 264, 41));
    ...
    private void btnloginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnloginActionPerformed
        ...
        try {
            ...
            pst.setString(2, txtpassword.getToolTipText());
            rs=pst.executeQuery();
            if(rs.next())
